...
if __name__ == "__main__":
    ...
    # Search with PRM
    t=PRM_planner.sample(n_pts=1000, sampling_method="uniform")      #t= has been added to get the threshold used in the sample function for the particular method
    PRM_planner.search(start, goal, t)                               #t has been added to the function call
    t=PRM_planner.sample(n_pts=1000, sampling_method="random")       
    PRM_planner.search(start, goal, t)
    t=PRM_planner.sample(n_pts=2000, sampling_method="gaussian")
    PRM_planner.search(start, goal, t)
    t=PRM_planner.sample(n_pts=20000, sampling_method="bridge")
    PRM_planner.search(start, goal, t)
